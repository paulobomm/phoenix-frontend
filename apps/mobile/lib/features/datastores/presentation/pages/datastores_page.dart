...
class _DataStoresPageState extends ConsumerState<DataStoresPage> {
  String _search = '';
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('Gerencie seus dados Roblox',
                            style: TextStyle(
                ...
                data: (stores) {
                  ...
                  if (filtered.isEmpty) {
                    return const EmptyStateWidget(
                      ...
                      description:
                          'Os datastores aparecerão aqui após a primeira descoberta automática.',
                    );
                  }
                  ...
                  return RefreshIndicator(
                    ...
                    onRefresh: () async {
                      ref.invalidate(datastoresProvider);
                    },
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, i) {
                        ...
                        return DataStoreCard(
                          datastore: ds,
                          onTap: () =>
                              context.push('/datastores/\${ds.id}/entries'),
                        );
                      },
                    ),
                  );
