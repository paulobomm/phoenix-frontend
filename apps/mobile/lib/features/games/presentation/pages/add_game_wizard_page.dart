    ...
    return Column(
      ...
      children: [
        ...
        PhoenixButton(
          ...
          onPressed: _apiKeyValid ? () => setState(() => _currentStep = 2) : _validateApiKey,
